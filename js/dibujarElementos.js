function crearProductoHTML(imagen, titulo, precio, contenedor) {
  let elemento = `
    <div>
    <img src="${imagen}" alt="">
...
function crearProductosHTMLADMIN2(id, imagen, titulo, precio, contenedor) {
  let elemento = `
      <div>
      <div class="layoutIconos">
      <a href="../productos/eliminarProducto.html?id=${id}">
      ...
      <a  href="../productos/actualizarProducto.html?id=${id}">
...
function crearElementosPorSeccion(modelo) {
...
function crearTodosLosElementosJuntos(modelo) {
...
function crearElementosAdmin(modelo) {
